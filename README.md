...
以下是已整合并扩展后的 `README.md` 或展示文档中的 **新增模块部分**，建议插入于原 Markdown 文档中“预测模型选择”之后的位置：
...
```
<img width="1189" height="590" alt="image" src="https://github.com/user-attachments/assets/e278c1f7-5ca9-4b75-802f-35d6d3a7002a" />
```
---
...
| 增加交易频率   | 可采用滚动窗口、双边布林带触发增强信号密度           |
| 纳入滑点成本模型 | 根据L2级别估计真实成交价，增强实战模拟能力          |
