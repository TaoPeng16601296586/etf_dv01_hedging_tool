...
## 使用框
<img width="2153" height="2021" alt="deepseek_mermaid_20250731_55d19d" src="https://github.com/user-attachments/assets/9554c990-6ae1-42ec-ab66-63d01c2b8a20" />
架流程

## 一个例子

场景设定
策略信号：模型预测价差将扩大（Ỹ = +0.8）。

当前市场：

ETF（511520）盘口：买价99.5元，卖价100.5元，中价100元。

期货（T2403）盘口：买价99.2元，卖价99.8元。

持仓状态：当前ETF净多头50手（inventory_risk = 50），阈值threshold = 100。

<img width="3891" height="2226" alt="deepseek_mermaid_20250731_9d00fd" src="https://github.com/user-attachments/assets/1c7eee96-165f-405d-9374-6bbc40e651fa" />

关键步骤说明
报价生成：

初始中价：(99.5 + 100.5) / 2 = 100元

看涨调整：买价98.75（吸引卖方），卖价99.23（因持仓不高，优先成交）。

成交与对冲：

交易对手以99.23元卖出ETF给做市商 → 做市商ETF多头+1手。

做市商立即以99.8元做空期货对冲。

收益来源：

方向性收益：若价差从(100 - 99.5)=0.5元扩大到1.0元，平仓获利。

做市收益：买入ETF成本99.23元，未来可高价卖出（如100.5元）。
